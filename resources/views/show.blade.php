	...
	<div class="container mx-auto px-4">
		<div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
			...
			<div class="lg:ml-12 lg:mr-64">
				...
				<p class="mt-12">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta ea eius ipsum nemo qui. Architecto
					ea eaque explicabo repellat ullam veniam! Distinctio, dolores ea eos esse ex excepturi incidunt iure
					magni, minus modi mollitia nostrum odio odit perferendis placeat quam quo reiciendis, rem repellat
					similique sint tempore ullam vero voluptates?
				</p>
				<div class="mt-12">
		...
		<div class="images-container border-b border-gray-800 pb-12 mt-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
				@foreach(range(1, 6) as $item)
					<div>
						<a href="#" class="">
							<img src="https://cdn.akamai.steamstatic.com/steam/apps/243470/capsule_616x353.jpg?t=1602605619" alt="alternate" class="hover:opacity-75 transition ease-in-out duration-150">
						</a>
					</div>
				@endforeach
			</div>
